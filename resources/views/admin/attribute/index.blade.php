                    ...
                    <div class="col-sm-8 m-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="theme-form theme-form-2 mega-form" action="{{ route('attribute.store') }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control @error('color') is-invalid @enderror" id="favcolor" type="color" placeholder="Colour" name="color" value="#ff0000">
                                            @error('color')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="form-group col-sm-9">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input @error('default') is-invalid @enderror" type="radio" name="default" id="featuredYes" value="1">
                                                <label class="form-check-label" for="featuredYes">Yes</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input @error('default') is-invalid @enderror" type="radio" name="default" id="featuredNo" value="0">
