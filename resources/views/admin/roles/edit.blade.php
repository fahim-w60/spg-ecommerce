                    ...
                    <div class="col-sm-8 m-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form class="theme-form theme-form-2 mega-form" action="{{ route('roles.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('name') is-invalid @enderror" type="text"
                                                placeholder="Role Name" name="name" value="{{ $data->name }}" value="{{ old('name') }}" required>
                                                @error('name')
