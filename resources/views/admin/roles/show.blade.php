                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <form action="{{ route('storeRoleInPermission') }}" class="theme-form theme-form-2 mega-form" method="POST" enctype="multipart/form-data">
                                    @csrf
                                                ...
                                                <div class="col-xl-12">
                                                    <ul>
                                                        ...
                                                        @foreach ($group as $group_wise_permission)
                                                            <li class="mx-5">
                                                                <input class="checkbox_animated childCheckbox" type="checkbox" name="permission[]" value="{{ $group_wise_permission->id }}" data-group="{{ $key }}" />
                                                                <label class="form-check-label m-0"
