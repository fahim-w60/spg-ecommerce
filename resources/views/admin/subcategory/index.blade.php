                            ...
                            <div class="card-body">
                                ...
                                <form class="theme-form theme-form-2 mega-form" action="{{ route('subcategory.store') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="js-example-basic-single w-100 form-control @error('name') is-invalid @enderror" name="categoryId">
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('name') is-invalid @enderror" type="text"
                                                placeholder="Subcategory Name" name="name" value="{{ old('name') }}">
                                                @error('name')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                        </div>
                                    ...
                                    <div class="mb-4 row align-items-center">
                                        ...
                                        <div class="col-sm-9">
                                            <input class="form-control @error('translation_name') is-invalid @enderror" id="banglaInput" type="text" placeholder="সাবক্যাটাগরি" name="translation_name" value="{{ old('translation_name') }}">
