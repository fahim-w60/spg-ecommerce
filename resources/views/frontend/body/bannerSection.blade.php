    ...
    <div class="container-fluid-lg">
        <div class="slider-4-banner no-arrow slick-height">
            <div>
                <div class=" banner-contain-3 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('frontend\banner-image\4.jpg') }}" class="" alt="">
                    </a>
            ...
            <div>
                <div class="banner-contain-3 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('frontend\banner-image\5.jpg') }}" class="" alt="">
                    </a>
                    <div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
                        <div>
            ...
            <div>
                <div class="banner-contain-3 hover-effect">
                    <a href="javascript:void(0)">
                        <img src="{{ asset('frontend\banner-image\7.jpg') }}" class="" alt="">
                    </a>
                    <div class="banner-detail p-center-left w-75 banner-p-sm mend-auto">
                        <div>
