...
@section('title')
Vendor Dashboard || FastKart Ecommerce 
@endsection
@section('main')
<div class="page-body">
                    ...
                    <div class="card-body p-0">
                        <div class="category-slider no-arrow">
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="adminBackend/assets/svg/vegetable.svg" class="img-fluid" alt="">
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="adminBackend/assets/svg/cup.svg" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>Beverages</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="adminBackend/assets/svg/meats.svg" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>Meats & Seafood</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="adminBackend/assets/svg/breakfast.svg" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>Breakfast</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="adminBackend/assets/svg/frozen.svg" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>Frozen Foods</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="adminBackend/assets/svg/milk.svg" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>Milk & Dairies</h6>
                                    </a>
                            ...
                            <div>
                                <div class="dashboard-category">
                                    <a href="javascript:void(0)" class="category-image">
                                        <img src="adminBackend/assets/svg/pet.svg" class="img-fluid" alt="">
                                    </a>
                                    <a href="javascript:void(0)" class="category-name">
                                        <h6>Pet Food</h6>
                                    </a>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        <img src="adminBackend/assets/images/product/1.png"
                                        ...
                                        <tr>
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        <img src="adminBackend/assets/images/product/2.png"
                                                            class="img-fluid" alt="Product">
                                                    </div>
                                                    <div class="product-name">
                                                        <h5>Aata Buscuit</h5>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="best-product-box">
                                                    <div class="product-image">
                                                        <img src="adminBackend/assets/images/product/3.png"
                                                            class="img-fluid" alt="Product">
                                                    </div>
                                                    <div class="product-name">
                                                        <h5>Aata Buscuit</h5>
